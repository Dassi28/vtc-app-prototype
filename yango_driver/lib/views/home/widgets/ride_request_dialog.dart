...
// import '../../../data/models/ride_request_model.dart'; // Uncomment if using strong typing
...
class RideRequestDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Parse data safely
    final price = requestData['total_price'] ?? 0;
    final distance = requestData['distance_km'] ?? 0;
